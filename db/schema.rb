...
ActiveRecord::Schema.define(version: 2020_11_12_103653) do
  ...
  create_table "delivery_destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_id"], name: "index_delivery_destinations_on_buy_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "last_name_full", null: false
    t.string "first_name_full", null: false
  ...
  add_foreign_key "delivery_destinations", "buys"
